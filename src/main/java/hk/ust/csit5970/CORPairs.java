...
public class CORPairs extends Configured implements Tool {
    ...
    private static class CORPairsMapper2 extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            for (String w1 : word_set) {
                for (String w2 : word_set.tailSet(w1, false)) { // Get words strictly greater than w1
                    pair.set(w1, w2);
     ...
     */
      private static class CORPairsReducer2 extends Reducer<PairOfStrings, IntWritable, PairOfStrings, DoubleWritable> {
